...
public class GetActThread implements Runnable {

    Handler handler;
    public GetActThread(Handler handler) {
        this.handler = handler;
    }

    @Override
    public void run() {
        String url = "http://112.74.35.75:8080/Entity/U3d616b41047817/CFIP/Activity/";
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                try {
                    URL urlImg = new URL("http://112.74.35.75:8080/file/U3d616b41047817/CFIP/Activity/"+String.valueOf(jsonArray.getJSONObject(i).optLong("id")));
